        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusCode = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FamilyBookDate = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DateOfAppointmentDecision = table.Column<DateOnly>(type: "date", nullable: false),
                    DateOfAppointmentVisa = table.Column<DateOnly>(type: "date", nullable: false),
                    DateOfModifiedAppointmentVisaDate = table.Column<DateOnly>(type: "date", nullable: false),
                    DateOfInsuranceStart = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeputationDecisionDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ExecutiveContractDate = table.Column<DateOnly>(type: "date", nullable: false),
                    StartAfterReturnDate = table.Column<DateOnly>(type: "date", nullable: false),
                    CountryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfContract = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SuspensionDate = table.Column<DateOnly>(type: "date", nullable: false),
                    SuspensionContractDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ReturnToServiceDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ReturnContractDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractDate = table.Column<DateOnly>(type: "date", nullable: false),
                    IssuingDepartmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DurationInDays = table.Column<int>(type: "int", nullable: false),
                    OrderDepartmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmpPunishments_Departments_IssuingDepartmentId",
                        column: x => x.IssuingDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_EmpPunishments_Departments_OrderDepartmentId",
                        column: x => x.OrderDepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EquivalenceDegreeContractDate = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RelinquishmentDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ContractDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractDate = table.Column<DateOnly>(type: "date", nullable: false),
                    EndDate = table.Column<DateOnly>(type: "date", nullable: false),
                    ModificationContractDate = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DateOfStart = table.Column<DateOnly>(type: "date", nullable: false),
                    DateOfRelinquishment = table.Column<DateOnly>(type: "date", nullable: false),
                    DateOfContract = table.Column<DateOnly>(type: "date", nullable: false),
                    ContractTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmpPersonalInfos_IdentityUserId",
                table: "EmpPersonalInfos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmpPunishments_IssuingDepartmentId",
                table: "EmpPunishments",
                column: "IssuingDepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_EmpPunishments_OrderDepartmentId",
                table: "EmpPunishments",
                column: "OrderDepartmentId");
