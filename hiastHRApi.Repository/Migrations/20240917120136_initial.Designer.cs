...
namespace hiastHRApi.Repository.Migrations
{
    ...
    [Migration("20240917120136_initial")]
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Constants.Branch", b =>
                {
                    ...
                    b.HasIndex(new[] { "DepartmentId" }, "IX_Branches_DepartmentId");

                    b.HasIndex(new[] { "SubDepartmentId" }, "IX_Branches_SubDepartmentId");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpAppointmentStatus", b =>
                {
                    ...
                    b.Property<DateOnly>("DateOfAppointmentDecision")
                        .HasColumnType("date");

                    b.Property<DateOnly>("DateOfAppointmentVisa")
                        .HasColumnType("date");

                    b.Property<DateOnly>("DateOfInsuranceStart")
                        .HasColumnType("date");

                    b.Property<DateOnly>("DateOfModifiedAppointmentVisaDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpDeputation", b =>
                {
                    ...
                    b.Property<DateOnly>("DeputationDecisionDate")
                        .HasColumnType("date");
                    ...
                    b.Property<DateOnly>("ExecutiveContractDate")
                        .HasColumnType("date");
                    ...
                    b.Property<DateOnly>("StartAfterReturnDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpMilitaryServiceSuspension", b =>
                {
                    ...
                    b.Property<DateOnly>("ReturnContractDate")
                        .HasColumnType("date");
                    ...
                    b.Property<DateOnly>("ReturnToServiceDate")
                        .HasColumnType("date");

                    b.Property<DateOnly>("SuspensionContractDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpPersonalInfo", b =>
                {
                    ...
                    b.Property<DateOnly?>("FamilyBookDate")
                        .HasColumnType("date");
                    ...
                    b.HasIndex(new[] { "IdentityUserId" }, "IX_EmpPersonalInfos_IdentityUserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpPunishment", b =>
                {
                    ...
                    b.Property<Guid>("OrderDepartmentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex(new[] { "IssuingDepartmentId" }, "IX_EmpPunishments_IssuingDepartmentId");

                    b.HasIndex(new[] { "OrderDepartmentId" }, "IX_EmpPunishments_OrderDepartmentId");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpQualification", b =>
                {
                    ...
                    b.Property<DateOnly?>("EquivalenceDegreeContractDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpRelinquishment", b =>
                {
                    ...
                    b.Property<DateOnly>("RelinquishmentDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpReward", b =>
                {
                    ...
                    b.HasIndex(new[] { "DepartmentId" }, "IX_EmpRewards_DepartmentId");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpVacation", b =>
                {
                    ...
                    b.Property<DateOnly>("ModificationContractDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpWorkPlace", b =>
                {
                    ...
                    b.Property<DateOnly>("DateOfRelinquishment")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Constants.Branch", b =>
                {
                    ...
                    b.HasOne("hiastHRApi.Domain.Entities.Constants.SubDepartment", "SubDepartment")
                        .WithMany("Branches")
            ...
            modelBuilder.Entity("hiastHRApi.Domain.Entities.Employee.EmpPunishment", b =>
                {
                    ...
                    b.HasOne("hiastHRApi.Domain.Entities.Constants.Department", "IssuingDepartment")
                        .WithMany("EmpPunishmentIssuingDepartments")
                        .HasForeignKey("IssuingDepartmentId")
                        .IsRequired();

                    b.HasOne("hiastHRApi.Domain.Entities.Constants.Department", "OrderDepartment")
                        .WithMany("EmpPunishmentOrderDepartments")
                        .HasForeignKey("OrderDepartmentId")
                        .IsRequired();
